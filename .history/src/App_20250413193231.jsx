...
function Homepage() {
  const images = ["./src/assets/carouone.jpg","./src/assets/carouone.jpg",
    "./src/assets/carouone.jpg","./src/assets/carouone.jpg","./src/assets/carouone.jpg",
    "./src/assets/carouone.jpg","./src/assets/carouone.jpg"
   ]
  return (
    <>
