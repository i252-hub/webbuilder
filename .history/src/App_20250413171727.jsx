...
<section className='servicesection'>
  ...
  <div className='serviceone'>
    ...
    <div className='serviceboxbottom'>
      <p>Real Estate Done Right</p>
      <p>Nervous about your property adventure? Don't be. Whether you're getting ready to buy or sell your residence, 
  ...
  <div className='serviceboxbottom'>
    ...
    <p>Large or small, condo or mansion, we can find it and get at the price that's right. Fixer-uppers? Luxury? We can help with all of it! We live, work, and play in this community.
  ...
  <div className='serviceboxbottom'>
    <p>Rely on Expertise</p>
    <p>If you have questions about affordability, credit, and loan options, 
      trust us to connect you with the right people to get the answers you need in a timely fashion. We make sure you feel confident and educated every step of the way.</p>
    </div>
  </div>
  </div>
</section>
