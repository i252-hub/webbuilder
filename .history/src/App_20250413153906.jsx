...
<div className='brands'>
  <div className='brandcontainer'><img className="brand" src="./src/assets/firstbrand"/></div>
  <div className='brandcontainer'><img className="brand" src="./src/assets/secondbrand"/></div>
  <div className='brandcontainer'><img className="brand" src="./src/assets/thirdbrand"/></div>
  <div className='brandcontainer'><img className="brand" src="./src/assets/fourthbrand"/></div>
</div>
